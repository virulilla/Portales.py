...
# Se establece la ubicación de la carpeta donde se almacenan las mdbs
ruta = raw_input("Ubicación mdbs HERE: ")
arcpy.env.workspace = ruta

# Se establece la ubicación de la carpeta donde se almacenan los datos de CartoCiudad
